...
# Gráfico de colunas da faixa salarial
...
# Converte a coluna para tipo Categoria com a ordem definida
...
with col1:
    st.subheader("Distribuição por genêro")
...
st.header('Salários vs. outras variáveis')
